import { hasAdjRank, hasRank,hasSuit,higherRank, id,lowerRank, rank, rankDiff, rankDist, suit, } from './card';
...
export const isRankAdj = c0 => c1 => hasAdjRank(rank(c0))(c1);

// adjRanks(c0).map(hasRank).some()
